                ...
                <div class="card-body card-body-modif">
                    ...
                    <div id="surat">
                        ...
                        <div class="surat-header">
                            ...
                            <div class="surat-header-body">
                                <div class="surat-header-body-line1">PEMERINTAH KABUPATEN CIANJUR
                                </div>
                                <div class="surat-header-body-line2">KECAMATAN CAMPAKA
                                </div>
                                <div class="surat-header-body-line3">KEPALA DESA SUSUKAN</div>
                                <div class="surat-header-body-line4">Alamat jl.sidangsari Desa Susukan Kecamatan Campaka
                                    Kode Pos 43214 www.susukan@kampungpinter.co.id e-mail: desasusukan24@gmail.com</div>
                            </div>
                        ...
                        <div class="surat-body">
                            <div>
                                Dibawah ini merupakan data Penduduk dari Desa Susukan<br>
                        ...
                        <!-- end body -->
                        <p>Yang bersangkutan adalah benar penduduk desa Ciramagirang kecamatan Campaka Kabupaten Cianjur
                        ...
                        <p>Berlaku sampai dengan tanggal :</p>
                    ...
                    <div class="surat-ttd">
                        <div class="surat-foot-ttd">
                            <div class="surat-foot-ttd-line1"></div>Susukan, 23 januari 2024
                            <div class="surat-foot-ttd-line2">Kepala desa Susukan</div>
                            <div class="surat-foot-ttd-line3"></div>
                            <div class="surat-foot-ttd-line4">Anis</div>
                            <div class="surat-foot-ttd-line5">NIP.</div>
                        </div>
                    </div>
