                ...
                <div id="surat">
                    ...
                    <div class="surat-header">
                        ...
                        <div class="surat-header-body">
                            <div class="surat-header-body-line1">PEMERINTAH {{ strtoupper(Session::get('kabupaten')) }}
                            </div>
                            <div class="surat-header-body-line2">KECAMATAN {{ strtoupper(Session::get('nama_kec')) }}
                            </div>
                            <div class="surat-header-body-line3">DESA {{ strtoupper(Session::get('nama_user')) }}</div>
                            <div class="surat-header-body-line4">{{ $config->alamat ?? '' }}</div>
                        </div>
                    ...
                    <div class="surat-body">
                        <div>
                            Dibawah ini merupakan data Penduduk dari Desa {{ ucwords(strtolower($data->nama_desa)) }}
                            Kecamatan {{ ucwords(strtolower($data->nama_kecamatan)) }}
                            {{ ucwords(strtolower($data->nama_kabupaten)) }} :
                        </div>
                        <div class="surat-body-line2">
                            <table>
                                ...
                                <tr>
                                    <td>NIK</td>
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->nik)) }}</td>
                                </tr>
                                <tr>
                                    <td>Nomor KK</td>
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->no_kk)) }}</td>
                                </tr>
                                <tr>
                                    <td>Jenis Kelamin</td>
                                    <td>:</td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->tmpt_lahir)).', '.date('d-m-Y', strtotime( $data->tgl_lahir )) }}
                                    </td>
                                </tr>
                                <tr>
                                <tr>
                                    <td>Agama</td>
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->agama)) }}</td>
                                </tr>
                                <td>Status&nbsp;Perkawinan</td>
                                <td>:</td>
                                <td>{{ ucwords(strtolower($data->status)) }}</td>
                                </tr>
                                <tr>
                                    <td>Pendidikan</td>
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->pendidikan)) }}</td>
                                </tr>
                                <tr>
                                    <td>Pekerjaan</td>
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->pekerjaan)) }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>RT</td>
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->rt)) }}</td>
                                </tr>
                                <tr>
                                    <td>RW</td>
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->rw)) }}</td>
                                </tr>
                                <tr>
                                    <td>Desa</td>
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->kel)) }}</td>
                                </tr>
                                <tr>
                                    <td>Kecamatan</td>
                                    <td>:</td>
                                    <td>{{ ucwords(strtolower($data->kec)) }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
