            ...
            <div class="modal-body">
                <form class="form-sample">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputUsername1">Tempat Meninggal</label>
                                <input type="text" class="form-control" id="exampleInputUsername1"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputUsername1">Pelapor/Pengaju Surat
                                </label>
                                <input type="text" class="form-control" id="exampleInputUsername1"
                                    placeholder="Pelapor/Pengaju Surat">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputUsername1">Hubungan Pelapor/Pengaju</label>
                                <input type="text" class="form-control" id="exampleInputUsername1"
                                    placeholder="Hubungan Pelapor/Pengaju">
                            </div>
                        </div>
                    </div>
                </form>
